  ...
  return (
    <div className="space-y-6">
      <div className="rounded-[32px] border border-white/10 bg-parchment/5 p-8 shadow-soft backdrop-blur-xl">
        <p className="text-sm uppercase tracking-[0.28em] text-gold">Sacred Journeys</p>
          ...
          return (
            <motion.button
              ...
              className={`group relative overflow-hidden rounded-[24px] border-2 p-6 text-left transition-all duration-300 ${
                isSelected
                  ? 'border-gold/60 bg-gradient-to-br from-gold/20 to-gold/5 shadow-glow'
                  : 'border-white/10 bg-midnight/40 hover:border-gold/30 hover:bg-midnight/60'
              }`}
            >
              ...
              <div className="relative z-10 space-y-3">
                ...
                {/* Selection indicator */}
                {isSelected && (
                  <div className="absolute top-3 right-3 rounded-full bg-gold/90 p-1">
