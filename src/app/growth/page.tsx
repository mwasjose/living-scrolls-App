  ...
  return (
    <div className="space-y-8 py-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="space-y-4 border-b border-border pb-6">
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
            {fruitsOfSpirit.map((fruit) => (
              <div key={fruit.name} className="border-b border-border pb-4">
        ...
        <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.1 }} className="space-y-4 border-b border-border pb-6">
          ...
          <div className="mt-5 space-y-3">
            {dailyDisciplines.map((discipline) => (
              <div key={discipline.name} className="flex items-center gap-3 border-b border-border py-3">
